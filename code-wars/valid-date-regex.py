...
def validate_date(date_str):
     rs = re.compile(r'\[(02-(0[1-9]|1[0-9]|2[0-8])|(01|03|05|07|08|09|10|12)-(0[1-9]|(1|2)[0-9]|3(0|1))|(04|06|09|11)-(0[1-9]|(1|2)([0-9])|30))\]')
     match = rs.search(date_str)
     if match:
             return True
...
valid = all(map(validate_date, cases))
print(valid)